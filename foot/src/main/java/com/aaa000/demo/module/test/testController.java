package com.aaa000.demo.module.test;
...
public class testController {
	...
	public String publicCorona1JsonNodeList(Model model) throws Exception {
		...
		String apiUrl = "http://apis.data.go.kr/1471000/CovidDagnsRgntProdExprtStusService/getCovidDagnsRgntProdExprtStusInq?serviceKey=hjrS1r6xqj%2FDoBq%2BJ5zC5adppQk4MC2FDVdEidU1jzDPEtFbrS%2F%2FHPTp4YcOvB1hcRSgqRiB8hBzDudnlcAwbQ%3D%3D&numOfRows=3&pageNo=1&type=json";
...
//		model.addAttribute(node);
		...
		return "xdm/dddd/publicCorona1JsonNodeList";
	}
