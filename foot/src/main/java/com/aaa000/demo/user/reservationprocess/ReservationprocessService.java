...
public class ReservationprocessService extends BaseService {
	...
	public int mauelete(List<Long> deleteIds) {
		return reservationprocessDao.mauelete(deleteIds);
	}
	// 예약 리스트 보여주기
	...
	public List<ReservationprocessDto> MatchList(int suSeq){
		return reservationprocessDao.MatchList(suSeq);
	}
	...
	public int reservationUpdate(ReservationprocessDto reservationprocessDto) {
		...
		return reservationprocessDao.reservationUpdate(reservationprocessDto);
	}
